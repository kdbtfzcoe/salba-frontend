    ...
    <div className="min-h-screen bg-gray-50 font-sans text-gray-800 flex flex-col">
      ...
      <main className="flex-grow w-full max-w-6xl mx-auto px-6 pb-16 space-y-8 -mt-24 relative z-30">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          {/* Card 1 */}
          <div className="bg-white p-10 rounded-2xl shadow-lg border border-gray-100 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300">
            ...
            <h3 className="text-2xl font-black text-slate-900 mb-4">Ano ang PROJECT SALBA?</h3>
            {/* CHANGED: text-justify is now text-left */}
            <p className="text-gray-600 leading-relaxed font-medium text-left">
          ...
          <div className="bg-white p-10 rounded-2xl shadow-lg border border-gray-100 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300">
            ...
            <h3 className="text-2xl font-black text-slate-900 mb-4">Paano ka poprotektahan ng PROJECT SALBA?</h3>
            {/* CHANGED: text-justify is now text-left */}
            <p className="text-gray-600 leading-relaxed font-medium text-left">
        ...
        {/* 7. Added subtle hover states to the smaller cards too */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-4">
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 text-center flex flex-col justify-center items-center hover:shadow-md hover:-translate-y-0.5 transition-all duration-200">
